...
import SchizophreniaHTMLTextBlock from "./schizophrenia-html-text-block";
    ...
    return (
        ...
        <div className="min-h-[80vh] p-8 bg-[#FBF9EB] pt-20 flex">
            ...
            <div className="w-1/2 flex flex-col justify-center max-h-140 p-12">
                ...
                <div className="mt-5">
                   <h1 className="text-5xl font-butler font-light">Schizophrenia Support Therapy</h1>
                    <p className="mt-5 font-space-mono">Schizophrenia and psychotic disorders require comprehensive treatment combining medication and therapy. Our supportive therapy helps manage symptoms, improve functioning, and enhance quality of life. We provide psychoeducation, coping strategies, and support for medication management. Book an appointment today for compassionate schizophrenia support.</p>
                </div>
            </div>
