...
import SexualAbuseHTMLTextBlock from "./sexual-abuse-html-text-block";
    ...
    return (
        ...
        <div className="min-h-[80vh] p-8 bg-[#FBF9EB] pt-20 flex">
            ...
            <div className="w-1/2 flex flex-col justify-center max-h-140 p-12">
                ...
                <div className="mt-5">
                   <h1 className="text-5xl font-butler font-light">Sexual Abuse Therapy</h1>
                    <p className="mt-5 font-space-mono">Healing from sexual abuse requires specialized, trauma-informed care that honors your experiences and supports your recovery. Whether the abuse occurred in childhood or adulthood, our evidence-based sexual abuse therapy provides a safe space to process trauma, reclaim your body, and rebuild your life. You deserve compassionate support from therapists who understand sexual trauma. Book an appointment today and take the first step toward healing.</p>
                </div>
            </div>
