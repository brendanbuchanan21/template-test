...
import AgoraphobiaHTMLTextBlock from "./agoraphobia-html-text-block";
    ...
    return (
        ...
        <div className="min-h-[80vh] p-8 bg-[#FBF9EB] pt-20 flex">
            ...
            <div className="w-1/2 flex flex-col justify-center max-h-140 p-12">
                ...
                <div className="mt-5">
                   <h1 className="text-5xl font-butler font-light">Agoraphobia Therapy</h1>
                    <p className="mt-5 font-space-mono">Agoraphobia causes intense fear of situations where escape might be difficult or help unavailable, leading to avoidance that restricts your life. If you avoid leaving home, public places, or crowds due to fear, agoraphobia therapy can help. Our evidence-based agoraphobia treatment uses gradual exposure to help you reclaim your freedom. Book an appointment today.</p>
                </div>
            </div>
