...
import AdolescentMentalHealthHtmlBlock from "./adolescent-mental-health-html-block";

const AdolescentMentalHealth = () => {
    return (
        <div className="flex">
            ...
            <div className="w-2/3 mt-[5rem] pr-5 pl-5">
                <div className="w-3/4">
                    ...
                    <AdolescentMentalHealthHtmlBlock />
...
export default AdolescentMentalHealth;
